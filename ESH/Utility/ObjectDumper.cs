...
namespace ESH.Utility
{
    ...
    public class ObjectDumper
    {
        ...
        /// <returns>String containing the information/values</returns>
        ...
        private string DumpElement(object element, bool isFIrstCall = false)
        {
            if (isFIrstCall)
            {
                if (element != null)
                {
                    Write(@"<" + element.GetType().ToString() + @">");
                }
            }
